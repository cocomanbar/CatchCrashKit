//
//  MamaNetworkChainRequestAgent.m
//  MamaNetwork
//
...
@interface MamaNetworkChainRequestAgent ()

@property (strong, nonatomic) NSMutableArray<MamaNetworkChainRequest *> *requestArray;

@end

@implementation MamaNetworkChainRequestAgent{
...
- (void)addChainRequest:(MamaNetworkChainRequest * _Nullable)request {
    if (![request isKindOfClass:MamaNetworkChainRequest.class]) {
        return;
    }
